            ...
            <ScrollView contentContainerStyle={{ flexGrow: 1, }}>
                <View style={{ justifyContent: 'space-between', flex: 1, }}>
                    <Animated.FlatList
                        ...
                        renderItem={({ item, index }: { item: onBoardDataType, index: number }) => {
                            return (
                                <OnboardCard
                                    item={item}
                    ...
                    <View style={{ marginBottom: 30 }}>
                        {currentPage != 2 ? <AppButton title="Next" onPress={() => handleNext()} /> :
                            <View style={{ marginBottom: 30, paddingHorizontal: 30, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }} >
                                <TouchableOpacity activeOpacity={0.5} style={styles.loginBtn} onPress={() => { }}>
                                    <Text style={styles.loginText}>Login</Text>
                                </TouchableOpacity>
                                <SizedBoxView width={8} />
                                <TouchableOpacity
                                    activeOpacity={0.5}
                                    style={styles.getStartedBtn} onPress={() => { }}>
